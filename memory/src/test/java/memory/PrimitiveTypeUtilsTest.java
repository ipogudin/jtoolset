...
public class PrimitiveTypeUtilsTest {
  ...
  public void sizeOfPritiveBooleanArray() {
    ...
    assertEquals(Address.alignment(Address.ARRAY_HEADER_SIZE + ARRAY_LENGTH * BOOLEAN_SIZE), 
        primitiveTypeUtils.sizeOfArray(a));
  }
  
  @Test
  public void sizeOfPritiveByteArray() {
    byte[] a = new byte[ARRAY_LENGTH];
    assertEquals(Address.alignment(Address.ARRAY_HEADER_SIZE + ARRAY_LENGTH * Byte.SIZE / 8), 
        primitiveTypeUtils.sizeOfArray(a));
  }
  ...
  public void sizeOfPritiveCharArray() {
    ...
    assertEquals(Address.alignment(Address.ARRAY_HEADER_SIZE + ARRAY_LENGTH * Character.SIZE / 8), 
        primitiveTypeUtils.sizeOfArray(a));
  }
  ...
  public void sizeOfPritiveShortArray() {
    ...
    assertEquals(Address.alignment(Address.ARRAY_HEADER_SIZE + ARRAY_LENGTH * Short.SIZE / 8), 
        primitiveTypeUtils.sizeOfArray(a));
  }
  ...
  public void sizeOfPrimitiveIntArray() {
    ...
    assertEquals(Address.alignment(Address.ARRAY_HEADER_SIZE + ARRAY_LENGTH * Integer.SIZE / 8), 
        primitiveTypeUtils.sizeOfArray(a));
  }
  ...
  public void sizeOfPrimitiveLongArray() {
    ...
    assertEquals(Address.alignment(Address.ARRAY_HEADER_SIZE + ARRAY_LENGTH * Long.SIZE / 8), 
        primitiveTypeUtils.sizeOfArray(a));
  }
  ...
  public void sizeOfPrimitiveFloatArray() {
    ...
    assertEquals(Address.alignment(Address.ARRAY_HEADER_SIZE + ARRAY_LENGTH * Float.SIZE / 8), 
        primitiveTypeUtils.sizeOfArray(a));
  }
  ...
  public void sizeOfPrimitiveDoubleArray() {
    ...
    assertEquals(Address.alignment(Address.ARRAY_HEADER_SIZE + ARRAY_LENGTH * Double.SIZE / 8), 
        primitiveTypeUtils.sizeOfArray(a));
  }
